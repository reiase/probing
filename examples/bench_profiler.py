...
def compare_overhead():
    ...
    print(f"Baseline completed: {baseline2_results['iterations']} iterations in {baseline2_results['total_time']:.2f}s")
    ...
    baseline2_iter_per_sec = baseline2_results['iterations'] / baseline2_results['total_time']
    profiled_iter_per_sec = profiled_results['iterations'] / profiled_results['total_time']
    baseline_percent = ((baseline_iter_per_sec - baseline2_iter_per_sec) / baseline_iter_per_sec) * 100
    ...
    print(f"Baseline2 performance: {baseline2_iter_per_sec:.2f} iterations/second, overhead: {baseline_percent:.1f}%")
    print(f"Profiled performance: {profiled_iter_per_sec:.2f} iterations/second, overhead: {overhead_percent:.1f}%")
